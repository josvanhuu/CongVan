define(["require", "exports", "jquery", "knockout", "toastr", "sweetalert", "../../common/common", "../../models/department/deparment-model", "jqueryPager", "resourceCommon"], function (require, exports, $, ko, toastr, swal, common_1, deparment_model_1) {
    ...
    var DepartmentViewModel = (function () {
        function DepartmentViewModel() {
            ...
            $(function () {
                //this.common.renderPage(this.title, 1, this.recordPerPage, 5, this.pageClickSearch(this));
                _this.search(1);
            });
        }
        ...
        DepartmentViewModel.prototype.pageClickSearch = function (pageclickednumber) {
            ...
            //this.model.load(pageclickednumber, (data) => {
            //    //this.isSearching(false);
            //    this.listdeparments(data.listDepartments);
            //    this.common.renderPage(this.title, pageclickednumber, this.recordPerPage, data.totalRecord, this.pageClickSearch);
            //});
            //var abc = this;
            //console.log(abc);
